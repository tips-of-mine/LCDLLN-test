...
RACE_SPECS = {
    ...
    "corrompus": {
        ...
        "collision": (0.48, 1.85),
        "bodyTypes": {
            "male": [("base", "Mutant", "Silhouette altérée par la corruption"),
                     ("twisted", "Difforme", "Mutations prononcées")],
            "female": [("base", "Mutante", "Silhouette altérée par la corruption"),
                       ("twisted", "Difforme", "Mutations prononcées")],
        },
        "headCount": {"male": 3, "female": 2},
        "hair": {
        ...
        "features": {"mutations": [("none", "Aucune"), ("spikes_minor", "Excroissances mineures"),
                                   ("spikes_major", "Excroissances majeures")]},
        "movement": {"walk": 3.6, "run": 7.2, "sprint": 10.8},
        "combat": {"baseHealth": 105, "baseStamina": 95, "baseMana": 125,
                   "bonusIntelligence": 3, "resistances": {"shadow": 15}},
        "additionalAnims": [],
        "factions": {"allowed": ["neutral"], "forbidden": ["alliance_light"]},
        "eyeEmissive": True,
    },
