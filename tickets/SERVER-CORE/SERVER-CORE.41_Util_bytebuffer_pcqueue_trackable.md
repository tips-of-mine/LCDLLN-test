...
Utile pour les flags compactés (server-core l'utilise pour les masques de
...
Inspiré de server-core : un `Tracker` partagé entre l'owner et les
...
- `SERVER-CORE_ANALYSIS.md` § Util (P3 cross)
- server-core `src/shared/Util/ByteBuffer.h`,
