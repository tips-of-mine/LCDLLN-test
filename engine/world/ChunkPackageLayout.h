...
{
	/// Chunk package segment types for progressive loading (M10.5, M100.5).
	/// Load order: Geo first, then Terrain (heightmap LOD0, M100.5),
	/// then Tex, Instances, Nav, Probes.
	...
	constexpr uint32_t kChunkSegmentCount = 6u;
