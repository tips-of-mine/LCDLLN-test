...
namespace
{
	...
	void Test_SetSurfaceSpeedMultiplier_0p5_StoredCorrectly()
	{
		ClientPredictionSystem sys;
		...
		// Test du stockage uniquement ; l'application en vélocité dans
		// ApplyCommand est privée (vérifiée par revue de la diff).
	}
...
int main()
{
	...
	Test_SetSurfaceSpeedMultiplier_0p5_StoredCorrectly();
