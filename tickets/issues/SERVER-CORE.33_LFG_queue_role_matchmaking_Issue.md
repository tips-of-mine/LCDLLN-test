...
- src/masterd/lfg/LfgQueue.h
- src/shared/network/LfgPayloads.h

## Note
LFG queue/matchmaking

---

## Contenu du ticket (SERVER-CORE.33)

# SERVER-CORE.33_LFG_queue_role_matchmaking

## Objectif

Mettre en place un **système Looking-For-Group / matchmaking** côté
master LCDLLN, inspiré de `src/game/LFG` server-core. Quatre piliers :
...
- SERVER-CORE.15 (Groups — création de groupe au match formé)
...
- `SERVER-CORE_ANALYSIS.md` § LFG (P3 master)
- server-core `src/game/LFG/LFGMgr.cpp`, `LFGQueue.cpp`,
  `LFGHandler.cpp`
