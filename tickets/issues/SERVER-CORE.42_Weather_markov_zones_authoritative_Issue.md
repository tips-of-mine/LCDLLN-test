...
- src/shardd/weather/WeatherManager.h
- src/shared/network/WeatherPayloads.h

## Note
Weather markov authoritative

---

## Contenu du ticket (SERVER-CORE.42)
