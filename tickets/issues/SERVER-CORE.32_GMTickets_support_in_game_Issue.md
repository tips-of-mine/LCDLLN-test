...
- src/masterd/gmtickets/GmTicketSystem.h
- src/shared/network/GmTicketPayloads.h

## Note
GMTickets CRUD + state machine

---

## Contenu du ticket (SERVER-CORE.32)
