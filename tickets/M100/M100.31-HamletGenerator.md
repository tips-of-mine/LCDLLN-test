...
| Chemin | Rôle |
|--------|------|
| `src/world_editor/HamletGeneratorTool.h/.cpp` | Outil. |
| `src/world_editor/HamletCommand.h/.cpp` | `ICommand` paste atomique. |
| `src/client/world/structures/HamletKitLibrary.h/.cpp` | Charge les kits. |
| `src/world_editor/tests/HamletTests.cpp` | Tests. |
...
add_library(engine_core
    ...
    src/world_editor/PlacementTool.cpp
    src/world_editor/HamletGeneratorTool.cpp
    src/world_editor/HamletCommand.cpp
