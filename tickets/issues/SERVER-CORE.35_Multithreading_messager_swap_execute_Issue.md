...
- src/shared/messager/Messager.h

## Note
Messager swap-execute MPSC

---

## Contenu du ticket (SERVER-CORE.35)

# SERVER-CORE.35_Multithreading_messager_swap_execute

## Objectif

Implémenter le pattern **`Messager`** inspiré de
`src/shared/Multithreading` server-core. Pattern : au lieu de protéger un
...
- `SERVER-CORE_ANALYSIS.md` § Multithreading (P3 cross)
- server-core `src/shared/Multithreading/Messager.h`
