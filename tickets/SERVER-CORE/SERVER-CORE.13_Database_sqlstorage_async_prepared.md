...
- **MySQL specific** : ces patterns assument MySQL. Si on veut PostgreSQL plus tard, rewrap. Server-Core a une couche multi-backend, on **ignore** par simplicité.
...
- `SERVER-CORE_ANALYSIS.md` § Database (P2 cross)
- server-core `src/shared/Database/SQLStorage.h`, `SqlDelayThread.cpp`,
