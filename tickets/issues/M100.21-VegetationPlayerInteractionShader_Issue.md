...
| Chemin | Rôle |
|--------|------|
| `src/client/world/foliage/EntityInfluenceCollector.h/.cpp` | Collecte + upload SSBO. |
| `src/client/world/foliage/tests/EntityInfluenceTests.cpp` | Tests + perf. |

### Fichiers à modifier

| Chemin | Modification |
|--------|--------------|
| `src/client/render/shaders/foliage.vert` | Ajout du loop d'influences. |
| `src/client/render/GpuDrivenCullingPass.cpp` | Bind du SSBO `Entities` sur le pipeline foliage. |
| `src/client/app/Engine.cpp` | Frame setup : `EntityInfluenceCollector::Update`. |
