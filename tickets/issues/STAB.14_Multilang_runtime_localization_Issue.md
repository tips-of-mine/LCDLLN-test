# STAB.14 — Système multilingue dynamique (runtime)
...
**Créés :**
- `engine/client/LocalizationService.h`
...
- **Compilation :** NON TESTÉ (environnement agent sans chaîne MSVC/vcpkg/Vulkan disponible).
- **Exécution :** NON TESTÉ.
...
- Implémentation réalisée strictement pour `STAB.14` :
  ...
  - écran de premier lancement avant l’auth,
  - écran `Options > Langue` avec application immédiate,
  - migration des textes `AuthUi` vers clés de traduction,
  - logs explicites,
  - tests unitaires du service de localisation.

---

## Contenu du ticket source (référence STAB.14)
